...
import hu.bme.mit.sysml.oosem.CommandHandler;
...
//		return resourceSet.getResources().stream().map(resource -> 
//			loadRootObject(null, resource.getURI().path())
//		).toList();
